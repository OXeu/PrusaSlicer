...
static std::vector<std::string> s_Preset_print_options {
    ...
    "gcode_comments", "gcode_label_objects", "output_filename_format",
    "enable_remote_slicing","remote_slicing_endpoint",
    "post_process", "gcode_substitutions", "perimeter_extruder",
